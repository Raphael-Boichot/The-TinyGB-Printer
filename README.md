...
**It supports all games compatible with the Game Printer (with all possible protocol tricks like double speed, compression, custom palette, break command, etc.) plus all homebrews known to date.**
