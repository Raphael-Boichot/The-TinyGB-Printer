...
**It supports all games compatible with the Game Printer (with all possible protocol tricks like double speed, compression, custom palette, break command, arbitrary lenght printing, etc.) plus all homebrews known to date.**
