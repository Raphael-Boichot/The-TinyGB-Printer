...
- *[Blarble1290](https://8bittygames.com/blarble1290/) by Patrick Rodriguez - A text based adventure where the printer talks to you, miserable human being !* (note: it will not print with a real printer, see next)
