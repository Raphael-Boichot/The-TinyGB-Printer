...
It's basically like a [BitBoy](https://gameboyphoto.bigcartel.com/product/bitboy) but outputting upscaled PNG images and with more functions (see next), but most of all, it's open source. You can copy, modify, improve it as you want. Just respect the license and the dedication of authors.
